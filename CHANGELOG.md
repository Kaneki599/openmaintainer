...
- Ignore local environment files, registry credentials, private keys, and certificate stores.
- Refresh the immutable Action reference generated by `openmaintainer init`.
- Normalize the npm CLI entry point.
